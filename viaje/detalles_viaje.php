<?php 
    $resTravel = file_get_contents("https://examen3aaroniweb.herokuapp.com/travels/edit/".$_GET['id']);
    $dataTravel = json_decode($resTravel);
    $viaje = $dataTravel->data->viaje[0];

    $resConductor = file_get_contents("https://examen3aaroniweb.herokuapp.com/users/edit/".$viaje->id_conductor);
