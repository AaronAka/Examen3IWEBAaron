<?php
    ...
    if (isset($_SESSION['login'])) {
        ...
        $resViajes = file_get_contents("https://examen3aaroniweb.herokuapp.com/viajesconductor/".$user['_id']);
        $dataViajes = json_decode($resViajes);

        $resViajesRes = file_get_contents("https://examen3aaroniweb.herokuapp.com/viajespasajero/".$user['_id']);
