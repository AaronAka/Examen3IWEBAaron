<?php
    session_start();
    $res = file_get_contents("https://examen3aaroniweb.herokuapp.com/conversaciones/".$_GET['id']);
    $data = json_decode($res);
    // $resViajes = file_get_contents("https://examen3aaroniweb.herokuapp.com/listaviajes");
